---
title: Draw cars using ggplot2
author: Umair Durrani
date: '2020-09-07'
slug: creating-your-own-geom-in-ggplot2
categories:
  - gem
tags:
  - ggplot2
...
## Credit: 
Thanks to [BrodieG](https://twitter.com/brodiegaslam?lang=en) for answeing my [stackoverflow question](https://stackoverflow.com/questions/22159087/is-it-possible-to-draw-diagrams-in-r) about drawing diagrams in R.  
...
```{r load_data}
df <- read_csv(here("static", "data", "driver_data.csv"))
...
```{r load_car_image}
car.raster <- png::readPNG(here("static", "data", "car4.png"))
...
car_rear.raster <- png::readPNG(here("static", "data", "car4_rear3.png"))
