...
date: '2020-09-13'
slug: combining-multiple-animations
categories:
  - gem
tags:
  - ggplot2
...
df <- read_csv(here::here("static", "data", "vb.csv"))
...
source("E:/OneDrive - University of Windsor/migrated/Dissertation/code/raw_code/creating_car_truck_geoms.R")
```
...
# Convertig the rendered gifs to magick class-------------
  ...
  c_mgif <- image_read(path = here::here("static", "data", "c_gif.gif"))
```
